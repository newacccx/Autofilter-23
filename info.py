...
# Bot information
API_ID = environ.get('API_ID', '6381607')
if len(API_ID) == 0:
...
if len(API_HASH) == 0:
    ...
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '5186977432:AAGuhZBPtXe4rJA_qofPWlEQJa0DAWQAz10')
if len(BOT_TOKEN) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '1258695344')
if len(ADMINS) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1001481389568 -1001540677762 -1002049285913').split()]
if len(INDEX_CHANNELS) == 0:
    print('Info - INDEX_CHANNELS is empty')
AUTH_CHANNEL = [int(auth_channels) for auth_channels in environ.get('AUTH_CHANNEL', '-1001540677762').split()]
if len(AUTH_CHANNEL) == 0:
    print('Info - AUTH_CHANNEL is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1001775402942')
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1001534042135')
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://newuser:newuser@cluster0.80t5h.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")
